...
5. 검증용 데이터셋의 loss가 더이상 떨어지지 않는다면 early stopping rule이 적용됩니다. (언제 학습을 종료할까는 매우 중요한 문제입니다..)
6. 실험이 잘 되었다면, 데이터 개수를 10배씩 늘릴 때, test.ipynb의 R2는 대략 10배씩 증가하고, MSE는 대략 10배씩 감소될 것이 기대됩니다.
