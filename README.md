...
2. train.ipynb : 신경망 모형 학습
* data_num : 몇 개의 데이터를 사용하여 신경망을 훈련할지 정하세요. 10,000의 배수여야 합니다.
3. test.ipynb : 신경망 성능 테스트
* train_data_num : 얼만큼 데이터를 사용해 학습된 신경망을 테스트 할 것인지 정하세요. 10,000의 배수여야 합니다.
* test_data_num : 테스트 데이터의 개수를 정하세요. 왠만하면 생성한 테스트용 데이터를 모두 사용하세요. 10,000의 배수여야 합니다.
